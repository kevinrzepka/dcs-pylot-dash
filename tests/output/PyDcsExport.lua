...
local function debug_lua_environment()
    log.write("PyDCSExport", log.INFO, log.INFO, "=== Lua Environment Debug ===")
    log.write("PyDCSExport", log.INFO, log.INFO, "Lua version:" .. _VERSION)
    log.write("PyDCSExport", log.INFO, log.INFO, "Package path:" .. package.path)
    log.write("PyDCSExport", log.INFO, log.INFO, "Package cpath:" .. package.cpath)
end
...
function LuaExportStart()
    ...
    if server then
        ...
        log.write("PyDCSExport", log.INFO, "HTTP Server started on " .. server_host .. ":" .. server_port)
    else
        log.write("PyDCSExport", log.ERROR, "Failed to create server socket")
    end
end
...
function LuaExportStop()
    if server then
        server:close()
        server = nil
        log.write("PyDCSExport", log.INFO, "HTTP Server stopped")
    end
